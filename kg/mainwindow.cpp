...
MainWindow::MainWindow(QWidget *parent)
    ...
    objproc->add_object(paralelepiped,paralelepiped_indicies,8,36,qRgb(144,173,245),{2,0,0});
    objproc->add_object(piramyd,piramyd_indicies,4,12,qRgb(128,0,128),{0,-0.9,0},{0.14,-0.5,0});
